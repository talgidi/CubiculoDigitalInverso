                ...
                <header className="flex items-center justify-between whitespace-nowrap border-b border-solid border-b-[#e5e7eb] dark:border-b-[#232f48] px-10 py-3">
                    ...
                    <nav className="hidden md:flex flex-1 justify-end gap-8">
                        ...
                        <div className="flex gap-2">
                            <button onClick={() => router.push("/signup")} className="flex min-w-[84px] max-w-[480px] cursor-pointer items-center justify-center overflow-hidden rounded-xl h-10 px-4 bg-[#1980e6] text-white text-sm font-bold leading-normal tracking-[0.015em]">
